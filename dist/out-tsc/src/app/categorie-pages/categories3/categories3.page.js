...
let Categories3Page = class Categories3Page {
    constructor() {
        this.items = [
            ...
            { name: "Men's Collection", img: "assets/Images/7.jpg", count: "15" },
            { name: "Women's Collection", img: "assets/Images/8.jpg", count: "12" },
        ];
    }
    ngOnInit() {
    }
};
Categories3Page = tslib_1.__decorate([
    Component({
...
export { Categories3Page };
//# sourceMappingURL=categories3.page.js.map